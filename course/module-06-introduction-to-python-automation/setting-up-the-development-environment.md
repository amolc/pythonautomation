...
- Understand the core concepts covered in *Setting up the development environment*
...
This chapter covers **Setting up the development environment** as part of Module 6: Introduction to Python Automation.
